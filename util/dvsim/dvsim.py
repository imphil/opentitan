...
def resolve_scratch_root(arg_scratch_root):
    ...
    if not arg_scratch_root:
        if scratch_root is None:
            ...
            (out, status) = utils.run_cmd_with_timeout(
                cmd="ls -d " + scratch_root, timeout=1, exit_on_failure=0
            )
            if status == 0 and out != "":
                ...
                log.warning(
                    ...
                    'Using "{}" instead.'.format(scratch_root, arg_scratch_root)
                )
    else:
...
def parse_args():
    ...
    parser.add_argument(
        "cfg", metavar="<cfg-hjson-file>", help="""Configuration hjson file."""
    )
    ...
    parser.add_argument(
        ...
        help=(
            "Parse the the given .hjson config file, list "
    ...
    buildg.add_argument(
        ...
        metavar="OPT",
        help=(
            "Additional options passed on the command line "
    ...
    buildg.add_argument(
        ...
        metavar="MODE",
        help=(
            "The options for each build_mode in this list "
    ...
    rung.add_argument(
        ...
        action="store_true",
        help=(
            "Skip the build step (assume that simulation "
    ...
    rung.add_argument(
        ...
        metavar="MODE",
        help=(
            "The options for each run_mode in this list are "
    ...
    rung.add_argument(
        "--xprop-off", action="store_true", help="Turn off X-propagation in simulation."
    )
    ...
    waveg.add_argument(
        ...
        const="default",
        help=(
            "Enable dumping of waves. It takes an optional "
    ...
    covg.add_argument(
        "--cov", "-c", action="store_true", help="Enable collection of coverage data."
    )
    ...
    covg.add_argument(
        ...
        action="store_true",
        help=(
            "Run coverage UNR analysis and generate report. "
    ...
    covg.add_argument(
        ...
        action="store_true",
        help=(
            "Rather than building or running any tests, "
