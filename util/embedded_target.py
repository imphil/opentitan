...
def main():
    ...
    parser.add_argument(
        "--objcopy", "-c", required=True, help="Absolute path to objcopy tool."
    )
    parser.add_argument(
        "--objdump", "-p", required=True, help="Absolute path to objdump tool."
    )
    parser.add_argument("--outdir", "-d", required=True, help="Output directory.")
    parser.add_argument(
        "--srec_cat", "-s", required=True, help="Absolute path to srec_cat tool."
    )
    ...
    run_srec_cat(args.srec_cat, bin_file, args.basename, args.outdir, word_size_bytes=4)
    run_srec_cat(args.srec_cat, bin_file, args.basename, args.outdir, word_size_bytes=8)
