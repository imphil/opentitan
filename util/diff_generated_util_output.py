...
testlist = [
    ["regdoc.md", False, "./regtool.py --doc > ", ""],
    ["uart_rtl", True, "./regtool.py -r -t ", " ../hw/ip/uart/data/uart.hjson"],
    ["uart_dv", True, "./regtool.py -s -t ", " ../hw/ip/uart/data/uart.hjson"],
    # generating include define headers
    ["uart.h", False, "./regtool.py -D ../hw/ip/uart/data/uart.hjson > ", ""],
    ["gpio.h", False, "./regtool.py -D ../hw/ip/gpio/data/gpio.hjson > ", ""],
    [
        "spi_device.h",
        False,
...
def main():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        subprocess.check_call(
            "git archive " + args.treeish + " | tar -x -C util/" + tmpdir_basename,
            shell=True,
        )
