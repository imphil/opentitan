...
def main():
    ...
    parser.add_argument(
        "-e", "--gen-env", action="store_true", help="Generate testbench UVM env code"
    )
    ...
    parser.add_argument(
        ...
        "--is-cip",
        action="store_true",
        help="""Is comportable IP - this will result in code being extended from CIP
    ...
    parser.add_argument(
        ...
        "--env-outdir",
        metavar="[hw/ip/<ip>]",
        help="""Path to place the full tetsbench code. It creates 3 directories - dv, data and doc.
    ...
    parser.add_argument(
        ...
        help="""Name of the vendor / entity developing the testbench. This is used to set the VLNV
    ...
    if not args.has_ral and (args.is_cip or args.has_interrupts):
        args.has_ral = True
        print(
            "NOTE: --has_ral switch is enabled since either "
