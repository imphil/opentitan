...
/**
 * Perform encrypt and decrypt operations. (Otherwise, only encrypt is done.)
 *
...
static void rsa_encrypt(otbn_t *otbn_ctx, const uint8_t *modulus,
  ...
  CHECK(otbn_memcpy_data_to_otbn(otbn_ctx, kOtbnVarRsaNLimbs, &n_limbs,
                                 sizeof(n_limbs)) == kOtbnOk);
  CHECK(otbn_memcpy_data_to_otbn(otbn_ctx, kOtbnVarRsaModulus, modulus,
                                 size_bytes) == kOtbnOk);
  CHECK(otbn_memcpy_data_to_otbn(otbn_ctx, kOtbnVarRsaIn, in, size_bytes) ==
        kOtbnOk);
  ...
  // Read back results.
  CHECK(otbn_memcpy_data_from_otbn(otbn_ctx, out, kOtbnVarRsaOut, size_bytes) ==
        kOtbnOk);
}
...
static void rsa_decrypt(otbn_t *otbn_ctx, const uint8_t *modulus,
  ...
  CHECK(otbn_memcpy_data_to_otbn(otbn_ctx, kOtbnVarRsaModulus, modulus,
                                 size_bytes) == kOtbnOk);
  CHECK(otbn_memcpy_data_to_otbn(otbn_ctx, kOtbnVarRsaExp, private_exponent,
                                 size_bytes) == kOtbnOk);
  CHECK(otbn_memcpy_data_to_otbn(otbn_ctx, kOtbnVarRsaIn, in, size_bytes) ==
        kOtbnOk);
...
static void test_rsa512_roundtrip(void) {
  static const uint8_t modulus[kRsa512SizeBytes] = {
  ...
  static const uint8_t private_exponent[kRsa512SizeBytes] = {
  ...
  static const uint8_t encrypted_expected[kRsa512SizeBytes] = {
  ...
  static const uint8_t in[kRsa512SizeBytes] = {
  ...
  rsa_roundtrip(kRsa512SizeBytes, modulus, private_exponent, in,
                encrypted_expected, out_encrypted, out_decrypted);
}

static void test_rsa1024_roundtrip(void) {
  static const uint8_t modulus[kRsa1024SizeBytes] = {
  ...
  static const uint8_t private_exponent[kRsa1024SizeBytes] = {
  ...
  static const uint8_t encrypted_expected[kRsa1024SizeBytes] = {
...
static void test_rsa2048_roundtrip(void) {
  ...
  static const uint8_t private_exponent[kRsa2048SizeBytes] = {
  ...
  static const uint8_t encrypted_expected[kRsa2048SizeBytes] = {
  ...
  static const uint8_t in[kRsa2048SizeBytes] = {"OTBN is great!"};
  uint8_t out_encrypted[kRsa2048SizeBytes] = {0};
  uint8_t out_decrypted[kRsa2048SizeBytes] = {0};

  LOG_INFO("Running RSA2048 test");
  rsa_roundtrip(kRsa2048SizeBytes, modulus, private_exponent, in,
                encrypted_expected, out_encrypted, out_decrypted);
}

static void test_rsa3072_roundtrip(void) {
  static const uint8_t modulus[kRsa3072SizeBytes] = {
  ...
  static const uint8_t private_exponent[kRsa3072SizeBytes] = {
  ...
  static const uint8_t encrypted_expected[kRsa3072SizeBytes] = {
  ...
  static const uint8_t in[kRsa3072SizeBytes] = {
  ...
  rsa_roundtrip(kRsa3072SizeBytes, modulus, private_exponent, in,
                encrypted_expected, out_encrypted, out_decrypted);
}

static void test_rsa4096_roundtrip(void) {
  static const uint8_t modulus[kRsa4096SizeBytes] = {
  ...
  static const uint8_t private_exponent[kRsa4096SizeBytes] = {
  ...
  static const uint8_t encrypted_expected[kRsa4096SizeBytes] = {
  ...
  static const uint8_t in[kRsa4096SizeBytes] = {"OTBN is doing RSA here"};
  uint8_t out_encrypted[kRsa4096SizeBytes] = {0};
  uint8_t out_decrypted[kRsa4096SizeBytes] = {0};

  LOG_INFO("Running RSA4096 test");
  rsa_roundtrip(kRsa4096SizeBytes, modulus, private_exponent, in,
                encrypted_expected, out_encrypted, out_decrypted);
}
