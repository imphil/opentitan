...
def main():
    ...
    parser.add_argument(
        "--n_alerts", type=int, default=4, help="Number of Alert Sources"
    )
    parser.add_argument(
        "--esc_cnt_dw", type=int, default=32, help="Width of escalation counter"
    )
    parser.add_argument(
        "--accu_cnt_dw", type=int, default=16, help="Width of accumulator"
    )
    parser.add_argument(
        "--async_on",
        type=str,
