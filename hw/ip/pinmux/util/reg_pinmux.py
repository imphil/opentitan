...
def main():
    ...
    parser.add_argument(
        "--n_mio_pads", type=int, help="Number of muxed IO pads", default=32
    )
    parser.add_argument(
        "--n_dio_periph_in",
        type=int,
    ...
    parser.add_argument(
        "--n_dio_pads", type=int, help="Number of dedicated IO pads", default=16
    )
    parser.add_argument(
        "--n_wkup_detect",
        type=int,
    ...
    parser.add_argument(
        "--wkup_cnt_width", type=int, help="With of wakeup counters", default=8
    )
    ...
    out.write(
        reg_tpl.render(
            n_mio_periph_in=args.n_mio_periph_in,
